...
// *********
    ...
    class Initiator(val id: String
                    , val reqParam: CostOfMaturationDTO?, val email: String?) : FlowLogic<SignedTransaction>() {
        companion object {
        ...
        override fun call(): SignedTransaction {
            ...
            val outputState: BatchState = vaultData.copy(
                    batchUpdateData = if (vaultData.batchUpdateData == null) {
                        UpdateBatchModel(
                                costOfMaturationData = reqParam?.let {
                                    CostOfMaturationModel(
                                            costOfMaturation = reqParam.costOfMaturation.toFloat(),
            ...
            val command = Command(BatchContract.BatchCommands.CostOfMaturation(), listOf(ourIdentity.owningKey))
