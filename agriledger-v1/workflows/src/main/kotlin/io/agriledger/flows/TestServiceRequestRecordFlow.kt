...
object TestServiceRequestRecordFlow {
...
// *********
    @InitiatingFlow
    @StartableByRPC
    class Initiator(val reqParam : ServiceRequestState
        ...
        override fun call(): SignedTransaction {
            ...
            val command = Command(ServiceRequestContract.Commands.TestServiceRequestRecord(), listOf(ourIdentity.owningKey))
