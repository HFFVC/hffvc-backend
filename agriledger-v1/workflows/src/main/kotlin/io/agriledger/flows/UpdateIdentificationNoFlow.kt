...
import io.agriledger.model.api.UpdateIdentificationNoDTO
...
object UpdateIdentificationNoFlow {
    // *********
// * Flows *
// *********
    @InitiatingFlow
    @StartableByRPC
    class Initiator(val reqParam: UpdateIdentificationNoDTO) : FlowLogic<SignedTransaction>() {
        companion object {
        ...
        override fun call(): SignedTransaction {
            ...
            val outputState: ServiceRequestState = vaultData.copy(
                    creationData = vaultData.creationData.copy(
                            cin = reqParam.cin,
                            nif = reqParam.nif
                    )
            )
            ...
            val command = Command(ServiceRequestContract.Commands.UpdateIdentificationNo(), listOf(ourIdentity.owningKey))
